    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle <?php echo (in_array($current_page, ['owner_dashboard', 'owner_cars', 'owner_bookings', 'owner_revenue', 'owner_contracts'])) ? 'active' : ''; ?>"
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="adminDropdown">
            ...
            <li>
              <a class="dropdown-item <?php echo ($current_page == 'admin_contracts') ? 'active' : ''; ?>"
                href="<?php echo BASE_URL; ?>/admin/contracts">
                <i class="fas fa-chart-bar me-1"></i> Quản lý hợp đồng
              </a>
            </li>
          </ul>
        </li>
