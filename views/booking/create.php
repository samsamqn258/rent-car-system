            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="car-summary mb-4">
                        <h4><?php echo $car_details['brand'] . ' ' . $car_details['model'] . ' (' . $car_details['year'] . ')'; ?>
                        </h4>
                        <div class="d-flex">
                            <div class="pe-4">
                                <img src="<?php echo BASE_URL . '/' . $car_details['images'][0]['image_path']; ?>"
                                    alt="<?php echo $car_details['brand'] . ' ' . $car_details['model']; ?>"
                                    style="width: 150px; height: 100px; object-fit: cover;">
                            </div>
                            <div>
                                <p><strong>Giá thuê:</strong> <?php echo number_format($car_details['price_per_day'], 0, ',', '.'); ?>
                                    VND / ngày</p>
                    ...
                    <form action="<?php echo BASE_URL . '/booking/create/' . $car_details['id']; ?>" method="post"
                        id="booking-form">
                        <div class="row">
                        ...
                        <div class="alert alert-success" id="pricing-info">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <strong id="total-price"><?php echo number_format($car_details['price_per_day'], 0, ',', '.'); ?>
                                    VND</strong>
                            </div>
                        </div>

                        <button type="submit" class="btn text-white btn-lg w-100 mt-3" style="background-color: #5fcf86;">Tiến hành
                            thanh toán</button>
                    </form>
                </div>
            </div>
