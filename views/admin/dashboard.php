            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6 col-lg-3 mb-3">
                    <div class="card bg-warning text-dark h-100">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <!-- Thêm liên kết vào số lượng đơn thuê xe -->
                                    <a href="<?php echo BASE_URL; ?>/admin/bookings" class="text-dark text-decoration-none">
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between">
                            <a href="<?php echo BASE_URL; ?>/admin/bookings" class="text-dark">Xem chi tiết</a>
                                            ...
                                            <?php foreach ($pending_cars as $car): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?php echo BASE_URL; ?>/cars/reject/<?php echo $car['id']; ?>" class="btn btn-sm btn-danger">
