                        ...
                        <div class="card-body">
                            <form action="<?php echo BASE_URL; ?>/admin/promotions/edit/<?php echo $promotion->id; ?>" method="post">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="code" name="code" required value="<?php echo isset($_SESSION['form_data']['code']) ? $_SESSION['form_data']['code'] : $promotion->code; ?>">
                                </div>

                                <div class="mb-3">
                                    <label for="discount_percentage" class="form-label">Phần trăm giảm giá</label>
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="discount_percentage" name="discount_percentage" min="1" max="100" required value="<?php echo isset($_SESSION['form_data']['discount_percentage']) ? $_SESSION['form_data']['discount_percentage'] : $promotion->discount_percentage; ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control" id="start_date" name="start_date" required value="<?php echo isset($_SESSION['form_data']['start_date']) ? $_SESSION['form_data']['start_date'] : date('Y-m-d\TH:i', strtotime($start_date)); ?>">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="end_date" class="form-label">Ngày kết thúc</label>
                                        <input type="datetime-local" class="form-control" id="end_date" name="end_date" required value="<?php echo isset($_SESSION['form_data']['end_date']) ? $_SESSION['form_data']['end_date'] : date('Y-m-d\TH:i', strtotime($end_date)); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="statusActive" value="active" <?php echo (isset($_SESSION['form_data']['status']) ? $_SESSION['form_data']['status'] == 'active' : $promotion->status == 'active') ? 'checked' : ''; ?>>
                                        <label class="form-check-label" for="statusActive">
                                            Hoạt động
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="statusInactive" value="inactive" <?php echo (isset($_SESSION['form_data']['status']) ? $_SESSION['form_data']['status'] == 'inactive' : $promotion->status == 'inactive') ? 'checked' : ''; ?>>
                ...
                <div class="col-md-4">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <p><strong>Cập nhật lần cuối:</strong> <?php echo date('d/m/Y H:i', strtotime($promotion->updated_at)); ?></p>
