                ...
                <div class="btn-toolbar mb-2 mb-md-0">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="periodDropdown">
                            <li><a class="dropdown-item <?php echo $period == 'day' ? 'active' : ''; ?>" href="<?php echo BASE_URL; ?>/admin/statistics?period=day&year=<?php echo $year; ?>">Hôm nay</a></li>
                            <li><a class="dropdown-item <?php echo $period == 'week' ? 'active' : ''; ?>" href="<?php echo BASE_URL; ?>/admin/statistics?period=week&year=<?php echo $year; ?>">Tuần này</a></li>
                            <li><a class="dropdown-item <?php echo $period == 'month' ? 'active' : ''; ?>" href="<?php echo BASE_URL; ?>/admin/statistics?period=month&year=<?php echo $year; ?>">Tháng này</a></li>
                            <li><a class="dropdown-item <?php echo $period == 'year' ? 'active' : ''; ?>" href="<?php echo BASE_URL; ?>/admin/statistics?period=year&year=<?php echo $year; ?>">Năm nay</a></li>
                        </ul>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h2 class="mb-0"><?php echo $statistics['total_bookings'] > 0 ? round(($statistics['completed_bookings'] / $statistics['total_bookings']) * 100) : 0; ?>%</h2>
                                </div>
                        ...
                        <table class="table table-hover" id="carRevenueTable">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    ...
                                    ?>
                                        <tr class="search-row" data-search="<?php echo strtolower($revenue['brand'] . ' ' . $revenue['model']); ?>">
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="<?php echo BASE_URL . '/' . $revenue['car_image']; ?>" alt="<?php echo $revenue['brand'] . ' ' . $revenue['model']; ?>" class="me-2 rounded" style="width: 40px; height: 30px; object-fit: cover;">
                                                    <div>
                                                        <div><?php echo $revenue['brand'] . ' ' . $revenue['model']; ?></div>
                                                        <small class="text-muted"><?php echo $revenue['car_type'] == 'electric' ? 'Xe điện' : ($revenue['car_type'] == 'gasoline' ? 'Xe xăng' : 'Xe dầu'); ?>, <?php echo $revenue['seats']; ?> chỗ</small>
                                                    </div>
                                                </div>
                                            </td>
