                            ...
                            <form action="<?php echo BASE_URL; ?>/admin/promotions/add" method="post">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="code" name="code" required
                                        value="<?php echo isset($_SESSION['form_data']['code']) ? $_SESSION['form_data']['code'] : ''; ?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="discount_percentage" name="discount_percentage"
                                            ...
                                            value="<?php echo isset($_SESSION['form_data']['discount_percentage']) ? $_SESSION['form_data']['discount_percentage'] : ''; ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control" id="start_date" name="start_date" required
                                            value="<?php echo isset($_SESSION['form_data']['start_date']) ? $_SESSION['form_data']['start_date'] : date('Y-m-d\TH:i'); ?>">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="end_date" class="form-label">Ngày kết thúc</label>
                                        <input type="datetime-local" class="form-control" id="end_date" name="end_date" required
                                            value="<?php echo isset($_SESSION['form_data']['end_date']) ? $_SESSION['form_data']['end_date'] : date('Y-m-d\TH:i', strtotime('+30 days')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="statusInactive" value="inactive"
                                            <?php echo (isset($_SESSION['form_data']['status']) && $_SESSION['form_data']['status'] == 'inactive') ? 'checked' : ''; ?>>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-warning">
                                <i class="fas fa-exclamation-triangle me-2"></i> Mã khuyến mãi sẽ áp dụng cho tất cả người dùng nếu đang
                                hoạt động.
                            </div>
                        </div>
                    </div>
