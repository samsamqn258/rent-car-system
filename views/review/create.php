          ...
          <div class="car-info mb-4">
            <div class="d-flex">
              <div class="me-3">
                ...
                <img src="<?php echo BASE_URL . '/' . $car_image; ?>" alt="<?php echo $car_brand . ' ' . $car_model; ?>"
                  style="width: 120px; height: 80px; object-fit: cover;" class="rounded">
                <?php else: ?>
                <img src="<?php echo BASE_URL; ?>/public/images/no-image.jpg" alt="No Image"
                  style="width: 120px; height: 80px; object-fit: cover;" class="rounded">
                <?php endif; ?>
              </div>
              <div>
                ...
                <a href="<?php echo BASE_URL; ?>/cars/details/<?php echo $car_id; ?>"
          ...
          <form action="<?php echo BASE_URL; ?>/review/create/<?php echo $booking_id; ?>" method="post">
              ...
              <div class="rating-stars mb-2">
                <div class="d-flex justify-content-center">
                  ...
                  <div class="form-check form-check-inline">
                    <input class="form-check-input d-none" type="radio" name="rating" id="rating<?php echo $i; ?>"
                      value="<?php echo $i; ?>"
                      <?php echo (isset($_SESSION['form_data']['rating']) && $_SESSION['form_data']['rating'] == $i) ? 'checked' : ($i == 5 ? 'checked' : ''); ?>>
            ...
            <div class="mb-4">
              ...
              <textarea class="form-control" id="comment" name="comment" rows="5"
                ...
                required><?php echo isset($_SESSION['form_data']['comment']) ? $_SESSION['form_data']['comment'] : ''; ?></textarea>
              <div class="form-text">Nhận xét của bạn sẽ giúp người dùng khác có quyết định tốt hơn khi thuê xe.</div>
            </div>

            <div class="d-grid gap-2">
              <button type="submit" class="btn text-white btn-lg" style="background-color: #5fcf86;">Gửi đánh
                giá</button>
              <a href="<?php echo BASE_URL; ?>/booking/details/<?php echo $booking_id; ?>"
