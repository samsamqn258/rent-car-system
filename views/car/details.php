      ...
      <div class="top-24 card border-0 shadow-sm" style="max-height: calc(100vh - 120px); overflow-y: auto;">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-start mb-3">
            <div>
              <h2 class="fw-bold">
                <?php echo $car_details['brand'] . ' ' . $car_details['model'] . ' (' . $car_details['year'] . ')'; ?>
              </h2>
          ...
          <div class="car-price mb-4">
            <h3 class="text-success fw-bold"><?php echo number_format($car_details['price_per_day'], 0, ',', '.'); ?>
          ...
          <?php elseif (!isset($_SESSION['user_id'])): ?>
            <a href="<?php echo BASE_URL . '/auth/login'; ?>" class="btn btn-success btn-lg w-100 mb-3 fw-semibold">ĐĂNG
              NHẬP ĐỂ ĐẶT XE</a>
          <?php endif; ?>
        </div>
      </div>
